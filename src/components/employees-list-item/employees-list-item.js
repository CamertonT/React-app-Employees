...
const EmployeesListItem = (props) => {
    ...
    if (increase && rise) {
        elementClass = "list-group-item d-flex justify-content-between increase like";
    } else if (increase) {
        elementClass = "list-group-item d-flex justify-content-between increase";
    } else if (rise) {
        elementClass = "list-group-item d-flex justify-content-between like";
    } else {
